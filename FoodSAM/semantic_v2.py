...
from FoodSAM_tools.enhance_semantic_masks_v2 import enhance_masks
...
parser.add_argument(
    '--color_list_path',
    type=str,
    default="FoodSAM/FoodSAM_tools/color_list.npy",
...
def main(args: argparse.Namespace) -> None:
    ...
    logger.info("Gabriel enhanced enhance semantic masks")
    enhance_masks(args.output, args.category_txt, args.color_list_path, args.img_path, num_class=args.num_class, area_thr=args.area_thr, ratio_thr=args.ratio_thr, top_k=args.top_k)
    logger.info("done!\n")
